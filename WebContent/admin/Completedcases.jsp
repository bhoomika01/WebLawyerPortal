...
<body>
	...
	String id=(String)session.getAttribute("ID");
		...
		ResultSet rs=s.executeQuery("SELECT Case_Id,Case_No,CaseType,Courttype,Description,First_Name FROM case_data,client_data where case_data.Client_Id=client_data.Login_Id and Lawyer_Id='"+id+"' and Status=4 ");
