...
<%@include file="menu.jsp" %>
	<%
		...
		ResultSet rs=s.executeQuery("SELECT Case_Id,CaseType,Courttype,Description,First_Name FROM case_data,client_data where case_data.Client_Id=client_data.Login_Id and Lawyer_Id='"+id+"' and Status=0 ");
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
						...
						while(rs.next())
						{
                          ...
                          <td>
                          	<span class="d-inline-block ml-1"><button><a href="approve.jsp?id12=<%=caseid %>">Approve</a></button></span>&nbsp;
                          	<span class="d-inline-block ml-1"><button><a href="reject.jsp?id12=<%=caseid%>">Reject</a></button></span>
                          </td>
