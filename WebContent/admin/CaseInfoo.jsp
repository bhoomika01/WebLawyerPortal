  ...
  <link rel='shortcut icon' type='image/x-icon' href='adminResources/img/favicon.ico' />
	<script type="text/javascript">
		function fun(){
			...
			var y=document.getElementById("sub1");
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#doc" role="tab"
                          aria-controls="contact" aria-selected="false">Add Documents</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#note" role="tab"
                          aria-controls="contact" aria-selected="false">Add Notes</a>
                      </li>
                  ...
                  <div class="form">
                      ...
                      <div class="tab-pane fade" id="next" role="tabpanel" aria-labelledby="contact-tab3">
				                ...
				                <div class="card">
				                  <form action="nexthearing.jsp">
				                    ...
				                    <div class="card-body">
				                      ...
				                      <div  class="form-group">
				                      	<lable>Orders</lable>
				                      	<textarea Display="none" id="order" rows="50" cols="20" name="note" class="form-control"></textarea>
				                      </div>
                       ...
                       <div class="tab-pane fade" id="doc" role="tabpanel" aria-labelledby="contact-tab3">
							...
							<div class="col-6 col-md-6 col-lg-6">
				                <div class="card"> 
                			 <form action = "adddoc.jsp" method="post"  enctype = "multipart/form-data">
				                    <div class="card-body">
						       ...
						       <div class="card-body">
				      				...
				      				<table class="table table-striped table-hover"
											...
											<%
				      					ResultSet rs3=s.executeQuery("SELECT * From document where Case_Id='"+caseid+"'");
				      						while(rs3.next()){
												date=rs3.getString("Date");
												file="../projectworkspace/Files/"+rs3.getString("File");
				      					...
				      					%>
												<tbody>
													<tr>
														<td><%=date %></td>
														<td><a href=<%=file %>><%=rs3.getString("File") %></a></td>														
													</tr>
												</tbody>
                      ...
                      <div class="tab-pane fade" id="note" role="tabpanel" aria-labelledby="profile-tab3">
								<div class="section-body">
									<div class="col-6 col-md-6 col-lg-6">
										<div class="card">
											<form action="AddNote.jsp">
												...
												<div class="card-body">
													...
													<div class="form-group">
														<lable>Notes</lable>
														<textarea rows="50" cols="20" name="note"
				                    ...
				                    <div class="card-body">
				      				...
				      				<table class="table table-striped table-hover"
											...
											<%
				      					ResultSet rs4=s.executeQuery("SELECT * From notes where Case_Id='"+caseid+"'");
				      						while(rs4.next()){
												date=rs4.getString("Date");
												note=rs4.getString("note");
