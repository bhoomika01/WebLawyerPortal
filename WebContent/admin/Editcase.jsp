...
<link rel='shortcut icon' type='image/x-icon'
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <link rel="stylesheet" href="assets/bundles/codemirror/theme/ ">
...
<div class="main-content">
			<!-- Main Content -->
		       ...
		       <% 
				...
				ResultSet rs=s.executeQuery("SELECT * FROM case_data Where Case_Id='"+id+"' ");
				while(rs.next())
				{
					CaseId=rs.getString("Case_Id");
					caseno=rs.getString("Case_No");
					lawyerid=rs.getString("Lawyer_Id");
					clientid=rs.getString("Client_Id");
					casetype=rs.getString("Casetype");
					courttype=rs.getString("Courttype");
					nexthearing=rs.getString("Nexthearing");
				}
				ResultSet rs4=s.executeQuery("SELECT * FROM Client_Data ");
