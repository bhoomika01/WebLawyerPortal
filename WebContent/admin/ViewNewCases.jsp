...
String id=(String)session.getAttribute("ID");
		...
		ResultSet rs=s.executeQuery("SELECT Case_Id,Case_No,CaseType,Courttype,Description,First_Name FROM case_data,client_data where case_data.Client_Id=client_data.Login_Id and Lawyer_Id='"+id+"' and Status=1  ");
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
						...
						while(rs.next())
						{
                          ...
                          <td>
                          	<%-- <span class="d-inline-block ml-1"><button><a href="Viewcase.jsp?id1=<%=caseid %>"><b>View</b></a></button></span>&nbsp; --%>
                          	<span class="d-inline-block ml-1"><button><a href="editstatus.jsp?id1=<%=caseid%>"><b>Edit</b></a></button></span>
                          </td>
