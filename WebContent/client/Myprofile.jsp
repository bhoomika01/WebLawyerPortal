...
<%
	...
	Connection x1=DriverManager.getConnection("jdbc:mysql://localhost:3308/lawyerportal","root","root");
	Statement s3=x1.createStatement();
	ResultSet rs3=s3.executeQuery("SELECT * FROM lawyer_data Where Login_Id='"+id+"' ");
	while(rs3.next())
	{
		fname=rs3.getString("First_Name");
		lname=rs3.getString("Last_Name");
		email=rs3.getString("Email_Id");
		mono=rs3.getString("Mobile_No");
		nationality=rs3.getString("Nationality");
		experience=rs3.getString("Year");
		prac=rs3.getString("AreaOfPrac");
		uni=rs3.getString("University_Name");
	}
%>		
                ...
                <div class="card author-box">
                  <div class="card-body">
                    <div class="author-box-center">
                      <img alt="image" src="adminResources/image/user-1.png" class="rounded-circle author-box-picture">
                  ...
                  <div class="padding-20">
                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                      ...
                      <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="profile-tab2">
                        <form method="post" action="editprofile.jsp" class="needs-validation">
                          <div class="card-header">
                            <h4>Edit Profile</h4>
                          </div>
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-5 col-12">
                                <label>Phone</label>
                                <input type="tel" class="form-control" name="mono" value="">
                              </div>
                            </div>
                            <div class="row">
