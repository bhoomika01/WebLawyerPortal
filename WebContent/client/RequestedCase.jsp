...
<body>
	...
	<%
		...
		ResultSet rs=s.executeQuery("SELECT Case_Id,Case_No,CaseType,Courttype,Description,First_Name FROM case_data,lawyer_data where case_data.Lawyer_Id=Lawyer_data.Login_Id and Client_Id='"+cid+"' and Case_Data.Status=0 ");
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    	...
                    	<center><h3>Requested Cases</h3></center>
